...
class ParamHandler():
    """
    'ParamHandler' class is created to pass on or modify input parameter values to the 'mainmodule'.
    At initialization, the required parameters are read from 'input_parameters.ini'.
    In case the file is modified and missing any parameters or contains extra parameters, exception is raised.
    """
    def __init__(self):
